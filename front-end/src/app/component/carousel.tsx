                        ...
                        <div>
                            <Card className="rounded-lg p-0 bg-card border">
                                ...
                                <CardContent className="mt-5">
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400">Giá khởi điểm: 30.000 VNĐ</p>
                                    <p className="text-slate-500 dark:text-slate-400">Thời gian đấu giá: 09/05/2024 08:00:00</p>
                                    <Button className="mt-10 w-full">Chi tiết</Button>
                                </CardContent>
                            </Card>
                        </div>
                    </CarouselItem>
